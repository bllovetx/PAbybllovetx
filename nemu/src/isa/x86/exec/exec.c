...
static OpcodeEntry opcode_table [512] = {
  ...
  /* 0x18 */	EMPTY, EMPTY, IDEXW(E2G,sbb,1), IDEX(E2G,sbb),
  ...
  /* 0x68 */	IDEX(I,push), EMPTY, IDEXW(push_SI,push,1), EMPTY,//push imm8 sext
  ...
  /* 0x80 */	IDEXW(I2E, gp1, 1), IDEX(I2E, gp1), IDEX(SI2E,gp1), IDEX(SI2E, gp1),
...
/*2 byte_opcode_table */
  ...
  /* 0x80 */	IDEX(J,jcc), IDEX(J,jcc), IDEX(J,jcc), IDEX(J,jcc),// op16 ??
